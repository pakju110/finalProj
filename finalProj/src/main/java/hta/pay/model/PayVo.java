...
public class PayVo {
	String
	rest_id,user_id,menu,phone,address,payhow,content,path="";
	
	Date reg_date;
	
	Integer price,count,totalprice=0;
	...
	//날짜 끝 
		...
		public String toString() {
			return "PayVo [rest_id=" + rest_id + ", user_id=" + user_id + ", menu=" + menu + ", phone=" + phone
					+ ", address=" + address + ", payhow=" + payhow + ", content=" + content + ", reg_date=" + reg_date
