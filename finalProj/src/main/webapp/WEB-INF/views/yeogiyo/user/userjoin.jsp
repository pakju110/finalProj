...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<form action="reg" method="post" enctype="multipart/form-data" name="jf">
		<table border="">
			<tr>
				<td>id</td>
				<td><input type="text" name="user_id" class="input" /><input type="button" onclick="idCheck()" name="sch" class="sch" value="id중복확인"/></td>
			</tr>
			<tr>
				<td>pw</td>
		...
		<tr>
			...
			<tr>
				...
				<td colspan="2" align="center"><c:if test='${idchek == "tr"}'><input type="submit" value="가입" /></c:if>
